...
# Stage-0 bootstrap: install decomk, clone config repo, run decomk.
# This replaces repo-specific setup.sh with a shared config-driven approach.
#
# The Go feature in devcontainer.json provides just enough Go to install
# decomk. The team's actual Go version is managed by goenv in the Makefile.
